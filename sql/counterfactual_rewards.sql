-- Capped and uncapped reward per (auction_id, solver), one row per winning
-- solution in the window whose orders are present in stg_backend_data__orders.
-- Rewards are signed: negative means the solver paid a penalty.
--
